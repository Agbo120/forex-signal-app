...
export function AdminSignalTable({ onEdit }: { onEdit: (signal: any) => void }) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableRow key={signal.id}>
            ...
            <TableCell className="text-right">
              <div className="flex justify-end gap-2">
                <Button variant="ghost" size="icon" onClick={() => onEdit(signal)}>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will permanently delete the signal for {signal.asset}. This action cannot be undone.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
